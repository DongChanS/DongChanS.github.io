...
1. 문자열 메서드
   ...
   rstrip, lstrip : 오른쪽, 왼쪽만 제거

   find와 index의 차이

2. 리스트 메서드

   extend와 list concatenate의 차이
...
5. __ 형식의 이상한 메서드들(special method)
   ...
   [Customizig attribute access](https://docs.python.org/3/reference/datamodel.html?highlight=__repr#customizing-attribute-access) 과 [Implementing Descriptors](https://docs.python.org/3/reference/datamodel.html?highlight=__repr#implementing-descriptors) 도 읽어보기.

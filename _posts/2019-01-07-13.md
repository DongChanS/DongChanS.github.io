...
3. 그래서 이걸 VSCODE에서는 몇가지 선택지로 잘 병합할 수 있다.(Accept Incoming Change)![5](C:\Users\student\Desktop\5.PNG)
...
4. 여기서 다시 add commit하면 git log에서 (HEAD -> new_world)가 확인된다.![7](C:\Users\student\Desktop\7.PNG)
...
8. man : help문서를 볼 수 있다.
9. rm : 파일제거 -> 매우 강력한 방법이니 cat로 확인해보고 지우자.
10. touch : 파일생성 -> 

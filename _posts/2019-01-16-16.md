...
1. **Inline style** : 각 태그마다 css문법을 집어넣어서 적용하기
   ...
   - color단위
     ...
     ![9_](C:\Users\student\Desktop\9_.png)
...
![10_](C:\Users\student\Desktop\10_.PNG)
...
- margin : 태그를 둘러싼 바깥쪽의 영역, 눈에는 보이지 않음
  ...
  ![11_](C:\Users\student\Desktop\11_.png)

- padding : 컨텐츠 주변을 둘러싼 영역

  ![12_](C:\Users\student\Desktop\12_.png)

- border : 경계선 자체(설정을 통해서 활성화가능)

  ![13_](C:\Users\student\Desktop\13_.png)
...
1. Content -> Typography
   ...
   ![14_](C:\Users\student\Desktop\14_.PNG)
...
- Bootstrap -> Components -> Card
  ...
  ![16_](C:\Users\student\Desktop\16_.PNG)

  반응형이므로 웹사이트를 줄이면 그리드에 맞게 줄여진다.

  ![17_](C:\Users\student\Desktop\17_.PNG)

  만약 그리드를 13개를 만든다면 OutOfGrid가 됨. -> 하나의 태그는 독립적으로 행동함.

  ![15_](C:\Users\student\Desktop\15_.PNG)
...
- 이걸 응용해서, form태그가 게맛살처럼 길게 늘여지는 현상을 방지할 수 있음.
  ...
  ![18_](C:\Users\student\Desktop\18_.png)

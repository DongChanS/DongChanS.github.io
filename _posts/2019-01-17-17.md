...
- center: 가운데정렬
- space-between : 요소들 사이의 거리를 동일하게 만들어서 정렬![2_](C:\Users\student\Desktop\2_.PNG)
- space-around : 요소들 사이의 margin을 동일하게 만들어서 정렬![1_](C:\Users\student\Desktop\1_.PNG)
...
- 해야할 것
  ...
  3. 결과사진 이어붙이기
     ...
     ![6_](C:\Users\student\Desktop\6_.PNG)FLEX와 Bootstrap을 이용하니 더 보기 괜찮아졌다.

<br>

**[Bootstrap 예시](https://getbootstrap.com/docs/4.2/examples/) 가져올때 주의해야할 점**

![1547712489323](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1547712489323.png)
